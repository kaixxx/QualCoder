...
data collected. This information will accompany every prompt sent to the AI, resulting in much more targeted results.')
    ...
    def _mcp_planner_system_prompt(self) -> str:
        return (
            ...
            "- If you need additional input, methodological decisions, or confirmation by the user, ask them "
            " by setting user_decision_required=true and providing a concise, natural language question in decision_question.\n"
    ...
    def _mcp_reflection_system_prompt(self) -> str:
        return (
            "Your task: Review collected data and action progress, then decide whether more MCP calls are needed, including whether additional methodological skill support is needed. "
            "Return ONLY one JSON object with this shape:\n"
            "{"
