...
class Ui_Dialog_ai_chat(object):
    def setupUi(self, Dialog_ai_chat):
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.widget_left_buttons)
        ...
        self.comboBox_ai_permissions.addItem("")
        self.comboBox_ai_permissions.addItem("")
        self.gridLayout_2.addWidget(self.comboBox_ai_permissions, 1, 1, 1, 3)
    ...
    def retranslateUi(self, Dialog_ai_chat):
        ...
        self.label_2.setText(_translate("Dialog_ai_chat", "AI Permissions:"))
