...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.pushButton_toggle_margin_highlight = QtWidgets.QPushButton(parent=self.groupBox_coding_buttons)
        self.pushButton_toggle_margin_highlight.setGeometry(QtCore.QRect(280, 0, 28, 28))
        self.pushButton_toggle_margin_highlight.setText("")
        self.pushButton_toggle_margin_highlight.setObjectName("pushButton_toggle_margin_highlight")
...
"\"Name:\", \"{Name}, or \"[Name]\""))
        ...
        self.pushButton_toggle_margin_highlight.setToolTip(_translate("Dialog_code_text", "Toggle code stripes margin"))
